...
Before you make a substantial pull request, consider opening an issue
and discussing your proposed changes. If you’ve found a bug, please
...
- Please **branch off of and make pull requests back to branch
  `devel`.**
...
Please note that the pkgreviewr project is released with a [Contributor
Code of
